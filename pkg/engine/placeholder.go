// IsPlaceholder recognises well-known documentation / template literals so
// they don't get reported as leaked secrets.
//
// Design rationale: docs/placeholder-filter.md
package engine
