...
var ruleDescriptions = map[string]string{
	...
	detectors.Twitch.String():                 "Twitch OAuth client_secret / app-access token (30-char lowercase base36 [0-9a-z]) near twitch keyword, verified via /oauth2/validate",
	...
	detectors.Workato.String():                "Workato API token (64-char hex [a-f0-9]{64}) near workato keyword, verified via /api/users/me with api-token: header",
	...
	detectors.Webex.String():                  "Cisco Webex personal access token (64-char lowercase hex [a-f0-9]{64}) near webex keyword, verified via /v1/people/me with Bearer auth",
