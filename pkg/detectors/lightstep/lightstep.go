...
// keys — long alphanumerics near the `lightstep` keyword. Verified via
// /public/v0.2/projects on api.lightstep.com with Bearer auth.
package lightstep
...
var contextKeywords = []string{"lightstep"}
