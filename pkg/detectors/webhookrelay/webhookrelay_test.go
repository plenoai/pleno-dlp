...
const dummyKey = "12345678-90ab-cdef-1234-567890abcdef"
const dummySecret = "abcdef01-2345-6789-abcd-ef0123456789"

func TestType(t *testing.T) {
	if (Scanner{}).Type() != detectors.WebhookRelay {
...
func TestFromData_Found(t *testing.T) {
	body := []byte("WEBHOOKRELAY_KEY=" + dummyKey + " WEBHOOKRELAY_SECRET=" + dummySecret)
