// Package vultr detects Vultr API keys (36-char alphanumeric near `vultr`)
// and verifies them via /v2/account.
//
// 36-char alphanumeric is too generic to surface alone; co-occurrence with
// `vultr` is mandatory.
package vultr
...
var apiBase = "https://api.vultr.com"
...
func (Scanner) Type() detectors.DetectorType { return detectors.Vultr }
