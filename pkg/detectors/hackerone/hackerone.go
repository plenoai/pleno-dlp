...
var apiBase = "https://api.hackerone.com"

var httpClient = detectors.NewVerifyHTTPClient(10 * time.Second)

var tokenRe = sync.OnceValue(func() *regexp.Regexp { return regexp.MustCompile(`\b([A-Za-z0-9_-]{20,80})\b`) })

var contextKeywords = []string{"hackerone", "h1_"}

type Scanner struct{}

func (Scanner) Type() detectors.DetectorType { return detectors.HackerOne }

func (Scanner) Keywords() []string { return []string{"hackerone"} }
...
func (s Scanner) FromData(ctx context.Context, verify bool, data []byte) ([]detectors.Result, error) {
	...
	res := detectors.Result{
		DetectorType: detectors.HackerOne,
		Raw:          []byte(ident),
