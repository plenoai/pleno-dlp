// Package taxjar detects TaxJar API tokens — long alphanumeric strings near
// the `taxjar` keyword. Verified via /v2/categories on api.taxjar.com with
// Bearer auth. The keyword window keeps the detector disjoint from the many
// other 40-alphanum-key shapes in the registry.
package taxjar
...
var contextKeywords = []string{"taxjar"}
