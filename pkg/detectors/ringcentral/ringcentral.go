// Package ringcentral detects RingCentral OAuth client_id + client_secret
// pairs near the `ringcentral` keyword. Verified via /restapi/oauth/token
// on platform.ringcentral.com using HTTP Basic auth (client_id as username,
// secret as password). Raw carries the client_id, RawV2 the secret.
package ringcentral
...
var contextKeywords = []string{"ringcentral"}
