// Package socure detects Socure identity-verification SDK keys near a
// `socure` keyword. Verified via /api/3.0/EmailAuthScore on
// api.socure.com with Authorization SocureApiKey header.
package socure
...
var contextKeywords = []string{"socure"}
