...
// prefilter; armRe carries the false-positive load.
...
// The window spans both directions so a key defined alongside a nearby
// SOCURE_API_KEY reference still arms.
