...
// username + password (each 16+ alphanumeric) near the `fastspring` keyword.
// Verified via /accounts on api.fastspring.com using HTTP Basic auth. Raw
// carries the username, RawV2 carries the password.
package fastspring
...
var contextKeywords = []string{"fastspring"}
