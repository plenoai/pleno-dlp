...
// account passwords. Unverified by design — Harbor is self-hosted
// per-deployment, so verification fires only when an apiBase override is
// supplied.
package harbor
...
// Authoritative: goharbor/harbor src/common/utils/utils.go wired in
// src/controller/robot/controller.go. Server-side IsValidSec() also
...
// enforced lower/upper/digit variety, so their Shannon entropy sits well
// above 3.5 bits/char.
