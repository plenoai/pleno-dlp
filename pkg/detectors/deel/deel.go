// Package deel detects Deel API tokens — 40+ char alphanumeric strings near
// the `deel` keyword. Verified via /rest/v2/users/me on api.letsdeel.com with
// Bearer auth.
package deel
...
var contextKeywords = []string{"deel", "letsdeel"}
