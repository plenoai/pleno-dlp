...
var apiBase = "https://platform.hootsuite.com"
...
func (Scanner) Type() detectors.DetectorType { return detectors.Hootsuite }

func (Scanner) Keywords() []string { return []string{"hootsuite"} }
...
func (s Scanner) FromData(ctx context.Context, verify bool, data []byte) ([]detectors.Result, error) {
	...
	for _, h := range hits {
		...
		res := detectors.Result{
			DetectorType: detectors.Hootsuite,
			Raw:          []byte(token),
