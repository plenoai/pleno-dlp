...
const dummyToken = "key_0123456789abcdef0123456789abcdef0123456789abcdef0123"

func TestType(t *testing.T) {
	if (Scanner{}).Type() != detectors.Runway {
...
func TestFromData_Found(t *testing.T) {
	body := []byte("RUNWAY_API_KEY=" + dummyToken)
...
func TestFromData_NoKeyword(t *testing.T) {
	...
	res, _ := Scanner{}.FromData(context.Background(), false, body)
	if len(res) != 0 {
		t.Fatalf("expected 0 without runway keyword, got %d", len(res))
	}
}
