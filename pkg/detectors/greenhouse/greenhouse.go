// Package greenhouse detects Greenhouse Harvest API keys — 40+ char
// alphanumeric strings near the `greenhouse` keyword. Verified via /v1/users
// on harvest.greenhouse.io with HTTP Basic auth (key as username).
package greenhouse
...
var contextKeywords = []string{"greenhouse", "harvest"}
