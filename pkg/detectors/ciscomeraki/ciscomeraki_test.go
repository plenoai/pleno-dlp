...
func TestType(t *testing.T) {
	if (Scanner{}).Type() != detectors.CiscoMeraki {
...
func TestVerify_OK(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.Header.Get("X-Cisco-Meraki-API-Key") != dummy {
			t.Errorf("auth mismatch: %q", r.Header.Get("X-Cisco-Meraki-API-Key"))
		}
