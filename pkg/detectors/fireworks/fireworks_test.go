...
const dummy = "fw_AbCdEf0123456789AbCdEf01"

func TestType(t *testing.T) {
	if (Scanner{}).Type() != detectors.Fireworks {
...
func TestFromData_Positive(t *testing.T) {
	body := []byte("FIREWORKS_API_KEY=" + dummy)
...
func TestFromData_NoKeyword(t *testing.T) {
	...
	if len(res) != 0 {
		t.Fatalf("expected 0 without fw_ prefix, got %d", len(res))
	}
}
