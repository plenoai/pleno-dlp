...
const dummy = "csk-AbCdEf0123456789AbCdEf0123456789"

func TestType(t *testing.T) {
	if (Scanner{}).Type() != detectors.Cerebras {
...
func TestFromData_Positive(t *testing.T) {
	body := []byte("CEREBRAS_API_KEY=" + dummy)
...
func TestFromData_NoKeyword(t *testing.T) {
	...
	if len(res) != 0 {
		t.Fatalf("expected 0 without csk- prefix, got %d", len(res))
	}
}
