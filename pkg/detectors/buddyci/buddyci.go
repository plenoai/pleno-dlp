// Package buddyci detects Buddy CI/CD personal access tokens — long base64url
// tokens near `buddy` keyword. Verified via /user on api.buddy.works using
...
// Buddy personal access tokens are documented as 64+ char base64url tokens.
var tokenRe = regexp.MustCompile(`\b([A-Za-z0-9]{40,80})\b`)

var contextKeywords = []string{"buddy", "buddy_token", "buddy_api", "buddy.works"}
