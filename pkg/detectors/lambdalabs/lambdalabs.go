...
// alphanumeric strings near the `lambdalabs` / `lambda_labs` keyword. Verified
// via /api/v1/instance-types on cloud.lambdalabs.com using HTTP Basic auth
// with the key as the username (no password).
package lambdalabs
...
var contextKeywords = []string{"lambdalabs", "lambda_labs", "lambda-labs"}
