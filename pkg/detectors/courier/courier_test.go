...
const dummyToken = "pk_prod_ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789ABCDEF"

func TestType(t *testing.T) {
	if (Scanner{}).Type() != detectors.Courier {
...
func TestFromData_Found(t *testing.T) {
	body := []byte("COURIER_AUTH_TOKEN=" + dummyToken)
