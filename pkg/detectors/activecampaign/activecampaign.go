// Package activecampaign detects ActiveCampaign API keys (>=60-char base64
// alnum). ActiveCampaign requires an account-specific host
// `https://<account>.api-us1.com` so verification is unverified-by-design —
// keyword + shape gating bound the false-positive rate.
