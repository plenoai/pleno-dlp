...
const dummy = "AbCdEf0123456789AbCdEf0123456789AbCdEf01_0123456789abcdef0123456789abcdef"

func TestType(t *testing.T) {
	if (Scanner{}).Type() != detectors.Lacework {
...
func TestRedact(t *testing.T) {
	...
	if !strings.HasPrefix(r, "AbCdEf012345") {
