// Package workato detects Workato API tokens (40-char base62) gated on the
// `workato` keyword window. Verification calls /api/users/me with the
// `Authorization: Bearer <token>` header on www.workato.com.
package workato
...
var contextKeywords = []string{"workato", "workato_token", "workato_api"}
