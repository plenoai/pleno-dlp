...
var contextKeywords = []string{"gitea"}

type Scanner struct{}

func (Scanner) Type() detectors.DetectorType { return detectors.Gitea }

func (Scanner) Keywords() []string { return []string{"gitea"} }
