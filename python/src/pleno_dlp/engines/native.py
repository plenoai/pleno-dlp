"""Built-in regex detection engine.
...
Use this engine when you want zero system dependencies. For verified
hits prefer the ``trufflehog`` engine.
"""
...
class NativeEngine:
    """Regex-only detection engine, no verification."""
