...
| 2026-09-22 | Devin, connector-engineer | Open repositories through `git.OpenRepository` (worktreeConfig + linked-worktree tolerant, fail-closed on unknown extensions) and blob-filter GitHub mirror clones at the scanner emission ceiling; partial-clone walks skip omitted promisor blobs without demand-fetching. |
