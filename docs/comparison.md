...
<!-- BENCH:AUTO:START -->
**Generated:** 2026-09-02T09:39:11Z · **Trigger:** competitor release detected (trufflehog 3.97.1, gitleaks 8.30.1) · **Full run:** `bench/results/results.json` / `bench/results/results.md` (uploaded as a workflow artifact)

| Tool | Version measured |
|---|---|
| pleno-dlp | pleno-dlp version dev (none) |
| trufflehog | trufflehog 3.97.1 |
