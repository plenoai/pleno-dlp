...
|--------|----------:|------------------:|----------------:|
| Detectors / rules | 614 | 870 | 222 |
| Live-verification capable | 552 (+62 unverified-by-design, see [`verify-coverage.md`](verify-coverage.md)) | most detectors (core design) | 0 — no verification subsystem |
...
7. **Detector breadth** — trufflehog ships 870 detector packages vs
   614 (long tail of niche SaaS providers).
