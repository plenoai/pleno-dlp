...
<!-- BENCH:AUTO:START -->
**Generated:** 2026-09-21T12:45:05Z · **Trigger:** pleno-dlp tag push v0.65.0 · **Full run:** `bench/results/results.json` / `bench/results/results.md` (uploaded as a workflow artifact)
